...
public class DebitAccount extends AbstractAccount {
    ...
    public DebitAccount(String number, double balance,LocalDate expirationDate) throws InvalidAccountNumberException {
    ...
    public DebitAccount(String s, double v) {
    ...
    private class InvalidAccountNumberException extends Throwable {
    }
}
